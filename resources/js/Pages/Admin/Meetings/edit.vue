...
const submit = () => {
    form.post(route("meetings.update", props.news.id),{
        forceFormData: true,
    });
};
...
const deleteFile = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("file.meetings",id),{
                forceFormData: true,
            });
        }
    })
                                                ...
                                                <template v-for="item in attacheds">
                                                    <tr>
                                                        <td class="px-4 py-3 text-sm">
                                                            <a :href="'/storage/meetings/attacheds/'+form.id+'/'+ item.file" target="_blank" >{{ item.file }}</a>
                                                        </td>
                                                        <td class="px-4 py-3 text-sm">
